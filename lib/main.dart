  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      items: ['assets/image1.jpg', 'assets/image2.jpg', 'assets/image3.jpg']
        ...
        if (i == 'assets/image1.jpg') {
          desc =
              'Keep track of all appointments at any time and easily add new services or offers';
        } else if (i == 'assets/image2.jpg') {
          desc =
              'Gain more customers through the supraregional reach of a digital platform';
        } else {
          desc =
              'Transport your load quickly and efficiently and thereby increase your turnover';
        }
